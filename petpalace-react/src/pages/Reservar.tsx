    ...
    <div className="reservar-page">
      ...
      <section className="reserva-section">
        <div className="reserva-header">
          <div>
            <h2>Encontre o hotel perfeito para o seu pet</h2>
            <p className="intro">Busca por cidade, região ou nome — acomodações pet-friendly com carinho 🐶🐱</p>
          </div>
        </div>
        ...
        <div className="search-bar">
          ...
          />
          <button aria-label="buscar"><span>🔎</span></button>
        </div>
